<template>
  <div class="document-convert-view">
    <div class="page-header">
      <h1 class="page-title">
        <el-icon class="title-icon"><Document /></el-icon>
        文档转换
      </h1>
      <p class="page-desc">将PDF文档转换为可编辑的Word格式，保留原有排版，快速高效</p>
    </div>
        ...
        >
          <div class="upload-content">
            ...
            <div class="upload-text">
              ...
              <p class="sub-text">支持 PDF 格式，单个文件不超过 100MB</p>
            </div>
          </div>
        </el-upload>
  ...
  for (let i = 0; i < fileList.value.length; i++) {
    ...
    try {
      ...
      if (file.file) {
        ...
        formData.append('conversionType', 'pdf2word')
...
.convert-btn:hover {
  background: linear-gradient(135deg, #8600d9, #e600b8);
}
